...
?>
	...
	<div class="col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading"><strong>Total Patients</strong></div>
	...
	<div class="col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading"><strong>Total Suppliers Ordered From:</strong></div>
			<div class="panel-body" align="center">
	...
	<div class="col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading"><strong>Total Supplement Brand</strong></div>
			<div class="panel-body" align="center">
	...
	<div class="col-md-3">
		<div class="panel panel-default">
			<div class="panel-heading"><strong>Total Supplemts in Stock</strong></div>
			<div class="panel-body" align="center">
	...
	?>
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Total Order Value From Suppliers</strong></div>
				<div class="panel-body" align="center">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Total Cash Order Value for Supplements</strong></div>
				<div class="panel-body" align="center">
