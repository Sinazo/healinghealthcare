...
(1, 'antimalarial', 'active'),
(2, 'anticonvulsant', 'active'),
(3, 'anaemia', 'active'),
(4, 'antacid', 'active'),
(5, 'antihelminthic', 'active'),
(6, 'labour-delivery', 'active'),
(7, 'antiprotozoal', 'active'),
(8, 'antiemetic', 'active'),
(9, 'sedative', 'active'),
(10, 'antibacterial', 'active'),
(11, 'respiratory', 'active'),
(13, 'antiallergic', 'active'),
(14, 'rehydration', 'active');
...
(1, 7, 4939.20, '2019-11-08', 'David Harper', '3188 Straford Park\r\nHarold, KY 41635', 'credit', 'active', '2019-11-08'),
(2, 7, 1310.40, '2019-11-08', 'Trevor Webster', '4275 Indiana Avenue\r\nHonolulu, HI 96816', 'cash', 'active', '2019-11-08'),
(3, 6, 265.65, '2019-11-08', 'Russell Barrett', '4687 Powder House Road\r\nJupiter, FL 33478', 'cash', 'active', '2019-11-08'),
(4, 6, 1546.80, '2019-11-08', 'Doloris Turner', '3057 Collins Avenue\r\nWesterville, OH 43081', 'credit', 'active', '2019-11-08'),
(5, 5, 1409.00, '2019-11-08', 'Georgette Blevins', '863 Simpson Avenue\r\nSteelton, PA 17113', 'cash', 'active', '2019-11-08'),
(6, 5, 558.90, '2019-11-08', 'Nancy Brook', '3460 Viking Drive\r\nBarnesville, OH 43713', 'credit', 'active', '2019-11-08'),
(7, 4, 1286.25, '2019-11-08', 'Joseph Smith', '190 Metz Lane\r\nCharlestown, MA 02129', 'cash', 'active', '2019-11-08'),
(8, 4, 1520.00, '2019-11-08', 'Maria Lafleur', '3878 Elkview Drive\r\nPort St Lucie, FL 33452', 'credit', 'active', '2019-11-08'),
(9, 4, 1604.00, '2019-11-08', 'David Smith', '4757 Little Acres Lane\r\nLoraine, IL 62349', 'cash', 'active', '2019-11-08'),
(10, 3, 1724.80, '2019-11-08', 'Michelle Hayes', '1140 C Street\r\nWorcester, MA 01609', 'cash', 'active', '2019-11-08'),
(11, 3, 1859.40, '2019-11-08', 'Brenna Hamilton', '2845 Davis Avenue\r\nPetaluma, CA 94952', 'cash', 'active', '2019-11-08'),
(12, 3, 2038.40, '2019-11-08', 'Robbie McKenzie', '3016 Horizon Circle\r\nEatonville, WA 98328', 'credit', 'active', '2019-11-08'),
(13, 2, 573.00, '2019-11-08', 'Jonathan Allen', '2426 Evergreen Lane\r\nAlhambra, CA 91801', 'cash', 'active', '2019-11-08'),
(14, 2, 1196.35, '2019-11-08', 'Mildred Paige', '3167 Oakway Lane\r\nReseda, CA 91335', 'cash', 'active', '2019-11-08'),
(15, 2, 1960.00, '2019-11-08', 'Elva Lott', '4032 Aaron Smith Drive\r\nHarrisburg, PA 17111', 'credit', 'active', '2019-11-08'),
(16, 2, 2700.00, '2019-11-08', 'Eric Johnson', '616 Devils Hill Road\r\nJackson, MS 39213', 'cash', 'active', '2019-11-08'),
(17, 1, 5615.20, '2019-11-09', 'Doris Oliver', '2992 Sycamore Fork Road Hopkins, MN 55343', 'cash', 'active', '2019-11-09'),
(26, 1, 2278.50, '2019-11-27', 'Janet Richardsons', '4799 Ryder Avenue Everett, WA 98210', 'credit', 'inactive', '2019-11-27');
...
(1, 'sinazoquest@gmail.com', '$2y$10$0Yo2F.EetL3yhB8l6MNvcOH8AYNS0SuXLOoAQr1qXJa3uPASWV0NC', 'Sinazo Ndwandwe', 'master', 'Active'),
