                    ...
                    <div class="panel-heading">
                    	<div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title"><b>Supplement List</b></h3>
                            </div>
                ...
                <form method="post" id="product_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Add Supplement</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="brand_id" id="brand_id" class="form-control" required>
                                    <option value="">Select Supplement Brand</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Enter Supplement Description</label>
            ...
            <div class="modal-dialog">
                <form method="post" id="product_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Supplement Details</h4>
                        </div>
                        <div class="modal-body">
