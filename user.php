        		...
        		<form method="post" id="user_form">
        			...
        			<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="email" name="user_email" id="user_email" class="form-control"placeholder="Enter Patient Email" required />
						</div>
						...
						<div class="form-group">
							<label>Enter Patient Collection Time</label>
							<input type="time" name="usr_time">
						</div>
						<div class="form-group">
							<label>Enter Patient Password</label>
							<input type="password" name="user_password" id="user_password" class="form-control" placeholder="Enter Patient Password"required />
						</div>
						<div class="form-group">
							<label>Enter Patient Address</label>
							<input type="text" name="user_address" id="user_address" class="form-control" placeholder="Enter Patient Address"required />
						</div>
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('#user_cellphone').val(data.user_cellphone);
				$('.modal-title').html("<i class='fa fa-pencil-square-o'></i> Edit Patient Data");
				$('#user_id').val(user_id);
				$('#action').val('Edit');
				$('#btn_action').val('Edit');
